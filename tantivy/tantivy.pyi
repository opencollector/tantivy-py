...
class Document:
    ...
    def get_all(self, field_name: str) -> Sequence[Any]:
        pass

    def __getitem__(self, field_name: str) -> Sequence[Any]:
        pass
...
class Query:
    ...
    @staticmethod
    def phrase_query(schema: Schema, field_name: str, words: Sequence[Union[str, tuple[int, str]]], slop: int = 0) -> Query:
        pass
...
class FacetCounts:
    def get(self, f: Facet) -> Iterator[tuple[Facet, int]]:
        pass

    def top_k(self, f: Facet, k: int) -> Sequence[tuple[Facet, int]]:
        pass

class SearchResult:
    @property
    def hits(self) -> Sequence[tuple[Any, DocAddress]]:
        pass
    ...
    @property
    def facet_axes(self) -> list[tuple[str, FacetCounts]]:
        pass
...
class Searcher:
    def search(
        ...
        offset: int = 0,
        facet_axes: Optional[Sequence[tuple[str, Sequence[Facet]]]] = None,
...
class Index:
    ...
    def parse_query(
        self, query: str, default_field_names: Optional[Sequence[str]] = None
    ) -> Query:
        pass
    ...
    @property
    def tokenizers(self) -> "TokenizerManager":
        pass
...
class Snippet:
    ...
    def highlighted(self) -> Sequence[Range]:
        pass
...
class Token:
    @property
    def get_offset_from(self) -> int:
        pass

    @property
    def get_offset_to(self) -> int:
        pass
...
class Tokenizer:
    def token_stream(self, text: str) -> TokenStream:
        pass

    @staticmethod
    def create_ngram_tokenizer(min_gram: int, max_gram: int, prefix_only: bool) -> "Tokenizer":
        pass
...
class TokenizerManager:
    def register(self, tokenizer_name: str, tokenizer: Tokenizer) -> None:
        pass

    def get(self, tokenizer_name: str) -> Optional[TextAnalyzer]:
        pass
